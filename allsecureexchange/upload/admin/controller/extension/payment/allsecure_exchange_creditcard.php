...
final class ControllerExtensionPaymentAllsecureExchangeCreditCard extends Controller
{
    ...
    {
        $this->load->language('extension/payment/allsecure_exchange_creditcard');
        ...
        $data['action'] = $this->url->link('extension/payment/allsecure_exchange_' . $this->type, 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/payment/allsecure_exchange', $data));
    }
    ...
    private function getBreadcrumbData()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/payment/allsecure_exchange_' . $this->type, 'user_token=' . $this->session->data['user_token'], true),
        ];
    ...
    {
        if (!$this->user->hasPermission('modify', 'extension/payment/allsecure_exchange_' . $this->type)) {
