...
final class ControllerExtensionPaymentAllSecureExchangeCreditCard extends Controller
{
    ...
    private $default = [
        'status' => 0,
        'title' => 'AllSecure Exchange Credit Card',
        'sort_order' => 1,
    ...
    {
        $this->load->language('extension/payment/all_secure_exchange_creditcard');
        ...
        $data['action'] = $this->url->link('extension/payment/all_secure_exchange_' . $this->type, 'user_token=' . $this->session->data['user_token'], true);
        ...
        $this->response->setOutput($this->load->view('extension/payment/all_secure_exchange', $data));
    }
    ...
    private function getBreadcrumbData()
    {
        ...
        $data['breadcrumbs'][] = [
            ...
            'href' => $this->url->link('extension/payment/all_secure_exchange_' . $this->type, 'user_token=' . $this->session->data['user_token'], true),
        ];
    ...
    {
        if (!$this->user->hasPermission('modify', 'extension/payment/all_secure_exchange_' . $this->type)) {
